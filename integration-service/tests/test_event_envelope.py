...
def test_counterparty_upsert_event():
    cp = Counterparty(id="abc-1", code="000001", name="ООО Ромашка",
                      inn="7701234567", kpp="770101001", ownership_form_id="ooo")
...
def test_counterparty_delete_event():
...
def test_ownership_form_event_key():
...
def test_event_id_unique_per_event():
